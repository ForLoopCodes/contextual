...
> **Complementary server:** [pmll-memory-mcp](https://www.npmjs.com/package/pmll-memory-mcp?utm_source=contextplus&utm_medium=readme&utm_campaign=complementary) (`npx pmll-memory-mcp`) is a separate MCP server by [@drQedwards](https://github.com/drQedwards) that adapts Context+'s long-term memory graph and adds short-term KV context memory, Q-promise deduplication, and a solution engine on top. See [drQedwards/PPM](https://github.com/drQedwards/PPM?utm_source=contextplus&utm_medium=readme&utm_campaign=complementary) and [drQedwards/pmll](https://github.com/drQedwards/pmll) for details.
>
> **P0 durability (Python package is the source of truth):** SQLite-backed graph, stable hashing embeddings, silo LRU eviction, and `init` reset. Implementation: [`pmll/mcp/pmll_memory_mcp/`](https://github.com/drQedwards/pmll/tree/main/mcp/pmll_memory_mcp) · mirror [`PPM/mcp/pmll_memory_mcp/`](https://github.com/drQedwards/PPM/tree/main/mcp/pmll_memory_mcp).
>
> **Retrieval-quality harness** (on `main` in both repos): [`mcp/benchmarks/benchmark_retrieval.md`](https://github.com/drQedwards/pmll/blob/main/mcp/benchmarks/benchmark_retrieval.md) + [`run_retrieval_stub.py`](https://github.com/drQedwards/pmll/blob/main/mcp/benchmarks/run_retrieval_stub.py) (same under [PPM/mcp/benchmarks/](https://github.com/drQedwards/PPM/tree/main/mcp/benchmarks)). It measures labeled retrieval hit rate (P@k / R@k / MRR) — **not** agent task accuracy. Toy stub only until the labeled pack grows; do not cite 99% / 99.99% (or any product accuracy %) from this harness. Traversal ranking fix is **MERGED** on `main` ([pmll#14](https://github.com/drQedwards/pmll/pull/14) → `bbd2eb8`, [PPM#76](https://github.com/drQedwards/PPM/pull/76) → `b60fd1e`); depth0/1 metrics diverge.
